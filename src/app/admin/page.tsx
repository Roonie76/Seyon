...
import { Users, ShoppingBag, Store, AlertTriangle, ShieldCheck, FileText, Flag, KeyRound, ScrollText, Mail } from 'lucide-react';
    ...
    <div className="container mx-auto px-4 py-8 md:py-12 flex flex-col gap-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-border pb-4">
        ...
        <Link href="/admin/notices">
          <Button variant="outline" className="gap-2" data-testid="nav-notices">
            <Mail size={16} /> Notices
          </Button>
        </Link>
