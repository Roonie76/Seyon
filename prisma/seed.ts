...
async function main() {
  ...
  const ap1 = await prisma.product.create({
    data: {
      ...
      inStock: true,
      images: { create: [{ url: '/uploads/perfumes/mystic_oud.png', isPrimary: true, displayOrder: 0 }] },
    },
  });
  ...
  const ap2 = await prisma.product.create({
    data: {
      ...
      status: ProductStatus.ACTIVE,
      inStock: true,
      images: { create: [{ url: '/uploads/perfumes/velvet_rose.png', isPrimary: true, displayOrder: 0 }] },
    },
  });
  ...
  const ap3 = await prisma.product.create({
    data: {
      ...
      status: ProductStatus.ACTIVE,
      inStock: true,
      images: { create: [{ url: '/uploads/perfumes/citrus_breeze.png', isPrimary: true, displayOrder: 0 }] },
    },
  });
